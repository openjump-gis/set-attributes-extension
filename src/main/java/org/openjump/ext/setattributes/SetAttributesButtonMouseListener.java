...
public class SetAttributesButtonMouseListener extends MouseAdapter {
  ...
  public String getHtmlToolTip(SetOfAttributes button) {
    ...
    text.append("<b>");
    text.append(i18n.get( "SetAttributesPlugIn.layer"));
    text.append("</b> : ");
    text.append(forHTML(button.getLayer()));

    text.append("<br><b>");
    text.append(i18n.get("SetAttributesPlugIn.transaction-mode"));
    text.append("</b> : ");
    text.append(button.isAtomic() ?
        i18n.get("SetAttributesPlugIn.transaction-mode.atomic") :
        i18n.get("SetAttributesPlugIn.transaction-mode.normal"));

    if (button.getDimension() > -1) {
      text.append("<br><b>");
      text.append(i18n.get("SetAttributesPlugIn.accepted-geometry-dimension"));
      text.append("</b> : ");
      text.append(button.getDimension());
    }

    text.append("<br><b>");
    text.append(i18n.get("SetAttributesPlugIn.attributes-changed"));
    text.append("</b> :");
    text.append("<ul>");
    for (SetAttribute att : button.getAttributes()) {
      ...
      if (att.getPrerequisite() != null && att.getPrerequisite().length() > 0) {
        text.append("<i>[");
        text.append(i18n.get("SetAttributesPlugIn.attributes-changed.if"));
        text.append(" ");
